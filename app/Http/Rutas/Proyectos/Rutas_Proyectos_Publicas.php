...
Route::get('/proyectos/{name}/{id}', [
    'uses' => 'Publicas\Paginas_Controller@get_pagina_new_proyecto_individual',
    'as'   => 'get_pagina_new_proyecto_individual']
);

//Proyectos Individuales
Route::get('/proyectos', [
    'uses' => 'Publicas\Paginas_Controller@get_pagina_new_proyecto_listado',
    'as'   => 'get_pagina_new_proyecto_listado']
);
