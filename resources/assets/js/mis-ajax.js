...
envio_de_peticion_post_ajax_con_alert('#solicitud-de-presupuesto-form', '#Envio-de-form', null); 

//envio la peticion de solicitud de contacto
envio_de_peticion_post_ajax_con_alert('#contact-form', '#Envio-de-form', null); 
